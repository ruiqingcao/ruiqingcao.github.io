...
<b>[<span style="color:#006400;font-size: 20px;">1405 - Mastering Data in the Real World with Python</span>](https://pcw.hhs.se/course/1405)</b> <span style="font-size: 20px;">(2025, 2026, M.Sc. SSE)</span> <br>
...
<b>[<span style="color:#006400;font-size: 20px;">2318 - AI Challenges to Business and Society</span>](https://pcw.hhs.se/course/2318)</b> <span style="font-size: 20px;">(2024, 2025, M.Sc. SSE)</span><br>
...
The module will cover how AI development relies on openly sourced publicly available content, and how the emergence of AI-based tools may influence the open-source community. We will also discuss copyright challenges in intellectual right protection of AI-generated works, and how using AI to aid the creation of innovations may challenge existing mechanisms of IP protection. <br>
